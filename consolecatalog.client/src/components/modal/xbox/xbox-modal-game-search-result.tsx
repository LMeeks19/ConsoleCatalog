...
import "../../../style/xbox/xbox-modal-game-search-result.css";
import { useNavigate } from "react-router-dom";
import Conditional from "../../site/if-then-else";
import { useSetRecoilState } from "recoil";
import { searchModalState } from "../../../functions/state";

function XboxModalGameSearchResult(props: GameSearchResultProps) {
  ...
  return (
    <div
      ...
      onClick={() => {
        ...
        navigate(`/xbox/games/${props.game.id}`, {
          state: {
...
export default XboxModalGameSearchResult;
