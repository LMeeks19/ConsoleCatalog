export const CLIENT_ID = "lpm1svjpeapgiyruyx8pratk8x54om";
export const CLIENT_SECRET = "yl42dzj8517v4v4zbrq06qma664vbw";
...
export const GAME_FIELDS =
  "first_release_date,id,name,storyline,summary,total_rating";
...
export const FULL_GAME_FIELDS = `${GAME_FIELDS},${ADD_ON_FIELDS},${IMAGE_FIELDS},${TONE_FIELDS},${PLATFORM_FIELDS}`;
